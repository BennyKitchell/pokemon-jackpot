...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:g7xe8UdBtykR1fQqJYUSkw==$o3VLVTz5R+TsI+tnsTWTxY25iKwSoI6cSyD70ZanM8w=:GOFgLboOfBvetbIvosfWYrHfuRwn1jf363ND68mAGbM=';
CREATE ROLE "user";
ALTER ROLE "user" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:ExpB8QVUCQSujdT+ER+W5Q==$w6jdQ8F8ZRWGBpBY4IisODqKhOTkDh1q7faazQ5FdPI=:BE7ygMEGvyBQH1zonJPYLY3fcclO0LKxZAwb//V/5Eo=';
...
--
-- Name: test; Type: DATABASE; Schema: -; Owner: user
--
...
--
-- Name: pokemons; Type: TABLE; Schema: public; Owner: user
--
...
ALTER TABLE public.pokemons OWNER TO "user";

--
-- Name: pokemons_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
ALTER SEQUENCE public.pokemons_id_seq OWNER TO "user";

--
-- Name: pokemons_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: user
--
...
--
-- Name: user_pokemons; Type: TABLE; Schema: public; Owner: user
--
...
ALTER TABLE public.user_pokemons OWNER TO "user";
...
--
-- Name: pokemons id; Type: DEFAULT; Schema: public; Owner: user
--
...
--
-- Data for Name: pokemons; Type: TABLE DATA; Schema: public; Owner: user
--
...
--
-- Data for Name: user_pokemons; Type: TABLE DATA; Schema: public; Owner: user
--
...
--
-- Name: pokemons_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: pokemons pokemons_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: users uni_users_email; Type: CONSTRAINT; Schema: public; Owner: user
--
